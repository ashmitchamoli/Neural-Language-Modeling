...
if __name__ == "__main__":
	...
	testPerplexity = inferencer.computePerplexity(testTokens, True, "perplexity_scores/2021101114-NNLM1-test-perplexity.txt")
	print(f"Test perplexity: {testPerplexity}")

	trainPerplexity = inferencer.computePerplexity(trainTokens, True, "perplexity_scores/2021101114-NNLM1-train-perplexity.txt")
